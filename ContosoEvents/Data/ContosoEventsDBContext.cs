...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=48B0LG2-SHEL\\SQLEXPRESS;Database=ContosoEventsDB;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<BookingDetail>(entity =>
            {
                ...
                entity.HasOne(d => d.BookingUser)
                    ...
                    .HasConstraintName("FK__Booking_D__Booki__412EB0B6");
            });
            ...
            modelBuilder.Entity<PaymentDetail>(entity =>
            {
                ...
                entity.HasOne(d => d.PaymentEvent)
                    ...
                    .HasConstraintName("FK__Payment_D__Payme__47DBAE45");

                entity.HasOne(d => d.PaymentPromo)
                    .WithMany(p => p.PaymentDetails)
                    .HasForeignKey(d => d.PaymentPromoId)
                    .HasConstraintName("FK__Payment_D__Payme__48CFD27E");
            ...
            modelBuilder.Entity<PromoCode>(entity =>
            {
                ...
                entity.HasIndex(e => e.PromoName, "UQ__Promo_Co__A3DCC22741CCB863")
                    .IsUnique();
            ...
            modelBuilder.Entity<UserDetail>(entity =>
            {
                ...
                entity.HasIndex(e => e.UserUserName, "UQ__User_Det__1C7BA84D21D0D05F")
                    .IsUnique();

                entity.HasIndex(e => e.UserEmail, "UQ__User_Det__4C70A05C9FFEC7E2")
                    .IsUnique();

                entity.HasIndex(e => e.UserContact, "UQ__User_Det__C84FD24D845AD04B")
                    .IsUnique();
